[{:func_name=>"gsl_multifit_linear",
 ...
 {:func_name=>"gsl_multifit_linear_lcurvature",
  ...
  :desc=>
   ...
   "regularization parameter \\lambda, using the right hand side\n" +
   "vector y, the vector of regularization parameters, reg_param,\n" +
   ...
   "values are stored in kappa on output."},
