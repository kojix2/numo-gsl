[{:func_name=>"gsl_sf_Chi",
 ...
 {:func_name=>"gsl_sf_bessel_il_scaled_array",
  ...
  :desc=>
   ...
   "lmax \\geq 0, storing the results in\n" +
 ...
 {:func_name=>"gsl_sf_bessel_jl_array",
  ...
  :desc=>
   ...
   "inclusive  for\n" +
   "lmax \\geq 0 and\n" +
   "x \\geq 0, storing the results in the array result_array.\n" +
   "The values are computed using recurrence relations for\n" +
   "efficiency, and therefore may differ slightly from the exact values.\n" +
   "Exceptional Return Values: GSL_EDOM, GSL_EUNDRFLW"},
 ...
 {:func_name=>"gsl_sf_bessel_jl_steed_array",
  ...
  :desc=>
   ...
   "lmax inclusive for\n" +
   "lmax \\geq 0 and\n" +
   "x \\geq 0, storing the results in the array\n" +
   "result_array.\n" +
 ...
 {:func_name=>"gsl_sf_bessel_kl_scaled_array",
  ...
  :desc=>
   ...
   "0 to lmax inclusive for\n" +
   "lmax \\geq 0 and x>0, storing the results in\n" +
   "the array result_array. \n" +
   "The values are computed using recurrence relations for\n" +
   "efficiency, and therefore may differ slightly from the exact values.\n" +
   "Exceptional Return Values: GSL_EDOM, GSL_EUNDRFLW"},
 ...
 {:func_name=>"gsl_sf_bessel_yl_array",
  ...
  :desc=>
   ...
   "inclusive for\n" +
   "lmax \\geq 0, storing the results in the array result_array.\n" +
   "The values are computed using recurrence relations for\n" +
   "efficiency, and therefore may differ slightly from the exact values.\n" +
   "Exceptional Return Values: GSL_EUNDRFLW"},
 ...
 {:func_name=>"gsl_sf_exp_err_e10_e",
  ...
  :desc=>
   ...
   "error dx using the :type:`gsl_sf_result_e10` type to return a result with\n" +
   "extended range.\n" +
   "Exceptional Return Values: "},
 ...
 {:func_name=>"gsl_sf_hazard_e",
  ...
  :desc=>
   "These routines compute the hazard function for the normal distribution.\n" +
   "Exceptional Return Values: GSL_EUNDRFLW"},
 {:func_name=>"gsl_sf_hermite",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the physicist Hermite polynomial H_n(x) of order n at position x.\r\n" +
   "If an overflow is detected, GSL_EOVRFLW is returned without calling the error handler.\r"},
 {:func_name=>"gsl_sf_hermite_array",
  :func_type=>"int",
  :args=>
   [["const int", "nmax"],
    ["const double", "x"],
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all physicist Hermite polynomials H_n up to order nmax at position x.\r\n" +
   "The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_array_deriv",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates the m-th derivative of all physicist Hermite polynomials H_n(x) from\r\n" +
   "orders 0, \\dots, \\text{nmax} at position x.\r\n" +
   "The result d^m/dx^m H_n(x) is stored in result_array[n]. The output\r\n" +
   "result_array must have length at least nmax + 1.\r"},
 {:func_name=>"gsl_sf_hermite_deriv",
  :func_type=>"double",
  :args=>[["const int", "m"], ["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the m-th derivative of the physicist Hermite polynomial H_n(x) of order n\r\n" +
   "at position x.\r"},
 {:func_name=>"gsl_sf_hermite_deriv_array",
  :func_type=>"int",
  :args=>
   [["const int", "mmax"],
    ["const int", "n"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all derivative orders from 0, \\dots, \\text{mmax} of the\r\n" +
   "physicist Hermite polynomial of order n, H_n, at position x.\r\n" +
   "The result d^m/dx^m H_n(x) is stored in result_array[m]. The output\r\n" +
   "result_array must have length at least mmax + 1.\r"},
 {:func_name=>"gsl_sf_hermite_deriv_e",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "n"],
  ...
  :desc=>
   "These routines evaluate the m-th derivative of the physicist Hermite polynomial H_n(x) of order n\r\n" +
   "at position x.\r"},
 {:func_name=>"gsl_sf_hermite_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const double", "x"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the physicist Hermite polynomial H_n(x) of order n at position x.\r\n" +
   "If an overflow is detected, GSL_EOVRFLW is returned without calling the error handler.\r"},
 {:func_name=>"gsl_sf_hermite_func",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the Hermite function \\psi_n(x) of order n at position x\r\n" +
   "using a three term recurrence relation. The algorithm complexity is O(n).\r"},
 {:func_name=>"gsl_sf_hermite_func_array",
  :func_type=>"int",
  :args=>
   [["const int", "nmax"],
    ["const double", "x"],
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all Hermite functions \\psi_n(x) for orders n = 0, \\dots, \\textrm{nmax}\r\n" +
   "at position x, using the recurrence relation algorithm. The results are stored in\r\n" +
   "result_array which has length at least nmax + 1.\r"},
 {:func_name=>"gsl_sf_hermite_func_der",
  :func_type=>"double",
  :args=>[["const int", "m"], ["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the m-th derivative of the Hermite function \\psi_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_func_der_e",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "n"],
  ...
  :desc=>
   "These routines evaluate the m-th derivative of the Hermite function \\psi_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_func_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const double", "x"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the Hermite function \\psi_n(x) of order n at position x\r\n" +
   "using a three term recurrence relation. The algorithm complexity is O(n).\r"},
 {:func_name=>"gsl_sf_hermite_func_fast",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the Hermite function \\psi_n(x) of order n at position x\r\n" +
   "using a the Cauchy integral algorithm due to Bunck, 2009. The algorithm complexity is O(\\sqrt{n}).\r"},
 {:func_name=>"gsl_sf_hermite_func_fast_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const double", "x"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the Hermite function \\psi_n(x) of order n at position x\r\n" +
   "using a the Cauchy integral algorithm due to Bunck, 2009. The algorithm complexity is O(\\sqrt{n}).\r"},
 {:func_name=>"gsl_sf_hermite_func_series",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"], ["const double *", "a"]],
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j \\psi_j(x) with \\psi_j being\r\n" +
   "the j-th Hermite function using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_func_series_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"],
    ["const double", "x"],
  ...
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j \\psi_j(x) with \\psi_j being\r\n" +
   "the j-th Hermite function using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_func_zero",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const int", "s"]],
  :desc=>
   "These routines evaluate the s-th zero of the Hermite function \\psi_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_func_zero_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const int", "s"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the s-th zero of the Hermite function \\psi_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_prob",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the probabilist Hermite polynomial He_n(x) of order n at position x.\r\n" +
   "If an overflow is detected, GSL_EOVRFLW is returned without calling the error handler.\r"},
 {:func_name=>"gsl_sf_hermite_prob_array",
  :func_type=>"int",
  :args=>
   [["const int", "nmax"],
    ["const double", "x"],
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all probabilist Hermite polynomials He_n(x) up to order nmax at position x.\r\n" +
   "The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_prob_array_deriv",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates the m-th derivative of all probabilist Hermite polynomials He_n(x) from\r\n" +
   "orders 0, \\dots, \\text{nmax} at position x.\r\n" +
   "The result d^m/dx^m He_n(x) is stored in result_array[n]. The output\r\n" +
   "result_array must have length at least nmax + 1.\r"},
 {:func_name=>"gsl_sf_hermite_prob_deriv",
  :func_type=>"double",
  :args=>[["const int", "m"], ["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the m-th derivative of the probabilist Hermite polynomial He_n(x)\r\n" +
   "of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_prob_deriv_array",
  :func_type=>"int",
  :args=>
   [["const int", "mmax"],
    ["const int", "n"],
  ...
  :desc=>
   "This routine evaluates all derivative orders from 0, \\dots, \\text{mmax} of the\r\n" +
   "probabilist Hermite polynomial of order n, He_n, at position x.\r\n" +
   "The result d^m/dx^m He_n(x) is stored in result_array[m]. The output\r\n" +
   "result_array must have length at least mmax + 1.\r"},
 {:func_name=>"gsl_sf_hermite_prob_deriv_e",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "n"],
  ...
  :desc=>
   "These routines evaluate the m-th derivative of the probabilist Hermite polynomial He_n(x)\r\n" +
   "of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_prob_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const double", "x"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the probabilist Hermite polynomial He_n(x) of order n at position x.\r\n" +
   "If an overflow is detected, GSL_EOVRFLW is returned without calling the error handler.\r"},
 {:func_name=>"gsl_sf_hermite_prob_series",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"], ["const double *", "a"]],
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j He_j(x) with He_j being the\r\n" +
   "j-th probabilist Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_prob_series_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"],
    ["const double", "x"],
  ...
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j He_j(x) with He_j being the\r\n" +
   "j-th probabilist Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_prob_zero",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const int", "s"]],
  :desc=>
   "These routines evaluate the s-th zero of the probabilist Hermite polynomial He_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_prob_zero_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const int", "s"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the s-th zero of the probabilist Hermite polynomial He_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_series",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"], ["const double *", "a"]],
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j H_j(x) with H_j being\r\n" +
   "the j-th physicist Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_series_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"],
    ["const double", "x"],
  ...
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j H_j(x) with H_j being\r\n" +
   "the j-th physicist Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_zero",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const int", "s"]],
  :desc=>
   "These routines evaluate the s-th zero of the physicist Hermite polynomial H_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_zero_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const int", "s"], ["gsl_sf_result *", "result"]],
  :desc=>
 ...
 {:func_name=>"gsl_sf_hydrogenicR",
  ...
  :desc=>
   ...
   ".. only:: not texinfo\n" +
   ".. only:: texinfo\n" +
   "where L^a_b(x) is the :ref:`generalized Laguerre polynomial <laguerre-functions>`.\n" +
 ...
 {:func_name=>"gsl_sf_hyperg_U_e10_e",
  ...
  :desc=>
   ...
   "U(a,b,x) using the :type:`gsl_sf_result_e10` type to return a\n" +
 ...
 {:func_name=>"gsl_sf_legendre_array",
  ...
  :desc=>
   ...
   "_e function. This factor is excluded by default."},
 ...
 {:func_name=>"gsl_sf_legendre_deriv_array_e",
  ...
  :desc=>
   ...
   "csphase to either -1 or 1 respectively in the\n" +
   "_e function. This factor is excluded by default."},
 {:func_name=>"gsl_sf_legendre_nlm",
  :func_type=>"size_t",
  :args=>[["const size_t", "lmax"]],
  :desc=>
   "This function returns the total number of associated Legendre\n" +
   "functions P_l^m(x) for a given lmax. The number is\n" +
   "(lmax+1) * (lmax+2) / 2."},
 ...
 {:func_name=>"gsl_sf_lnpoch_sgn_e",
  ...
  :desc=>
   ...
   "with a corresponding error term,  and sgn = \\sgn((a)_x) where (a)_x = \\Gamma(a + x)/\\Gamma(a)."},
 ...
 {:func_name=>"gsl_sf_rect_to_polar",
  ...
  :desc=>
   ...
   "polar coordinates (r, theta), such that x = r\\cos(\\theta),\n" +
   "y = r\\sin(\\theta).  The argument theta\n" +
