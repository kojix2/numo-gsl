[{:func_name=>"gsl_multilarge_linear_L_decomp",
 ...
 {:func_name=>"gsl_multilarge_linear_matrix_ptr",
  ...
  :desc=>
   "For the normal equations method, this function returns a pointer to the X^T X matrix\n" +
   "of size p-by-p. For the TSQR method, this function returns a pointer to the\n" +
   "upper triangular R matrix of size p-by-p."},
 ...
 {:func_name=>"gsl_multilarge_linear_rhs_ptr",
  ...
  :args=>[["const gsl_multilarge_linear_workspace *", "work"]],
  :desc=>
   "For the normal equations method, this function returns a pointer to the p-by-1 right hand\n" +
   "side vector X^T y. For the TSQR method, this function returns a pointer to a vector of length\n" +
   "p+1. The first p elements of this vector contain z_1, while the last element\n" +
   "contains ||z_2||."},
